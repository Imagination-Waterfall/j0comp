j0: tree.o lex.yy.o j0gram.tab.o type.o category.o symt.o tcheck.o tac.o codegen.o main.o
	gcc -g -Og -Wall -o j0 tree.o lex.yy.o j0gram.tab.o type.o category.o symt.o tcheck.o tac.o codegen.o main.o
